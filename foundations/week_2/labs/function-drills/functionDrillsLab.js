...
function add(num1, num2) {
  let num1ForSure = parseInt(num1)
  let num2ForSure = parseInt(num2)

  return num1ForSure + num2ForSure
}
...
function emailCheck(email) {
  let formattedEmail = email.trim(email.toString())
...
let testEmail = 'johnsonav' + 1992 + '@gmail.com    '
...
function chocFrogs(gold) {
  ...
  let frogsPurchased = gold / costOfFrog
  return frogsPurchased
}

console.log(chocFrogs(100))
...
function chocFrogs2(gold) {
  ...
  let result = parseInt(frogsPurchased)
  return result
}

console.log(chocFrogs2(100))
...
function isAscending(arr) {
  return arr.every((number, i) => {
    return i === 0 || number >= arr[i - 1]
  })
}
